create function get_resultat(v_lot_id bigint, v_state integer, v_organ_name character varying, v_maloy character varying, v_from_summa bigint, v_to_summa bigint, v_proc_id integer, v_date1 timestamp without time zone, v_date2 timestamp without time zone) returns text
    language plpgsql
as
$$
Declare
...
BEGIN
    ...
    for r in SELECT rm.id,
             ...
             FROM resultat_method rm
                      ...
                      FULL OUTER JOIN man_organizations$payload$data mpd
