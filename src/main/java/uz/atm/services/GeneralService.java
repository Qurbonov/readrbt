...
public class GeneralService {
	...
	public GeneralService(ResultatMethodRepository resultatMethodRepository,
	                      ContractInfoRepository contractInfoRepository, ErrorInfoRepository errorInfoRepository,
	                      FacturalInfoRepository facturalInfoRepository, RequestEtpRepository requestEtpRepository,
	                      RkpEndRepository rkpEndRepository)
	{
	...
	public void parse(String str) throws JsonProcessingException
	{
		...
		if (Objects.nonNull(general.getMETHOD_NAME()))
		{
           ...
           /* if (methodName.equals(Methods.RESULTAT.toString())) {
			...
			if (methodName.equals(Methods.CONTRACT_INFO.toString()))
			{
